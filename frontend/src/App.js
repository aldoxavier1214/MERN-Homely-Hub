...
function App() {
  const stripePromise = loadStripe("pk_test_51P7f2ISGnPzUVsl7Zo7IhRfyaljM6tjyE8JyZdElRyR9pxbGHUfH49xNfyJSrIoXCf5Z9POrqoPVN8DB2vp6qotr00dsnmdSHF");
  ...
  const router=createBrowserRouter(
    createRoutesFromElements(
      ...
      <Route id="accomodation" path="accomodationform" element={<AccomodationForm/>}/> */}
      </Route>
    )
  );
  return (
    <div className="App">
     ...
     <ToastContainer
     position="bottom-center" autoClose={3000} draggable={true} transition={Flip}/>
    </div>
  );
}
